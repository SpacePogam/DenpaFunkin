...
local ofsy = 0
local mult = 1.25
characterNames = {'norman', 'rick', 'mary', 'jasber', 'adrian', 'moo', 'rotten', 'tempester-player','avid-player'} --character json name
...
function setVariation()
  ...
  elseif variation == 2 then
    characterNames = {'pixel-norman', 'rick', 'mary', 'jasber', 'adrian', 'moo', 'rotten', 'tempester-player','avidtransform-player'} --character json name
