...
local ofsy = 0
local mult = 1.25
characterNames = {'norman', 'rick-player', 'jasber-player', 'adrian', 'moo-player'} --character json name
characterDisplays = {'Norman (Press Left/Right to change, and Up/Down to change variant.)', 'Rick', 'Jasper and Amber', 'Adrian', 'Moo'} --display name for text
...
function setVariation()
  ...
  elseif variation == 2 then
    characterNames = {'pixel-norman', 'rick-player', 'jasber-player', 'adrian', 'moo-player'} --character json name
    characterDisplays = {'Pixel Norman', 'Rick', 'Jasper and Amber', 'Adrian', 'Moo'} --display name for text
