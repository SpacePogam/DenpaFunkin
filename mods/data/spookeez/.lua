...
local ofsy = 0
local mult = 1.25
characterNames = {'norman', 'rick-player', 'mary-player', 'adrian', 'moo-player', 'rotten-player', 'tempester-player','avid-player'} --character json name
characterDisplays = {'Norman (Press Left/Right to change, and Up/Down to change variant.)', 'Rick', 'Mary', 'Adrian', 'Moo', 'Rotten Puff', 'Tempester','Avid'} --display name for text
...
function setVariation()
  ...
  elseif variation == 2 then
    characterNames = {'pixel-norman', 'rick-player', 'mary-player', 'adrian', 'moo-player', 'rotten-player', 'tempester-player','avidtransform-player'} --character json name
    characterDisplays = {'Pixel Norman', 'Rick', 'Mary', 'Adrian', 'Moo', 'Rotten Puff', 'Tempester','Avid(Dark)'} --display name for text
