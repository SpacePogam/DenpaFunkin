...
local ofsy = 0
local mult = 1.25
characterNames = {'norman', 'rick-player', 'mary-player', 'jasber-player', 'adrian', 'moo-player', 'rotten-player', 'tempester-player','avid-player'} --character json name
characterDisplays = {'Norman (Press Left/Right to change, and Up/Down to change variant.)', 'Rick', 'Mary', 'Jasper and Amber', 'Adrian', 'Moo', 'Rotten Puff', 'Tempester','Avid'} --display name for text
characterLimit = {2, 1, 1, 1, 1, 1, 1, 1, 2} --how many variations does the character have
maxpage = 9 --amount of characters u have
...
function setVariation()
  ...
  elseif variation == 2 then
    characterNames = {'pixel-norman', 'rick-player', 'mary-player', 'jasber-player', 'adrian', 'moo-player', 'rotten-player', 'tempester-player','avidtransform-player'} --character json name
    characterDisplays = {'Pixel Norman', 'Rick', 'Mary', 'Jasper and Amber', 'Adrian', 'Moo', 'Rotten Puff', 'Tempester','Avid(Dark)'} --display name for text
